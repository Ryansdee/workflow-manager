...
export default function RegisterPage() {
  ...
  const [formData, setFormData] = useState({
    firstName: '', lastName: '', email: '', password: '', confirmPassword: '', company: '', teamSize: '1-5', agreeToTerms: false
  });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await setDoc(doc(db, "users", userCredential.user.uid), {
        uid: userCredential.user.uid, ...formData, plan: selectedPlan, createdAt: serverTimestamp()
      });
